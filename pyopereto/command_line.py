...
"""
| PyOpereto Command Line enables you to control and manage opereto from your shell command line.
| For more information on installation:
| https://docs.opereto.com/opereto-framework/getting_started/prepare-dev-environment/
